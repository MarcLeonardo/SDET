...
public class Test8 {		
		...
		public void invalidEmail() throws InterruptedException {	
			...
			//arrange
			WebElement emailError = driver.findElement(By.xpath("//span[@id='email-err']"));
			
			//act
			String actualEmailErrorAlert = emailError.getText();
			
			//assert
			Assert.assertEquals(actualEmailErrorAlert, "Please enter a valid email");
			...
			//order should not have pushed through with invalid email
		}
