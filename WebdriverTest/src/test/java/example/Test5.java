...
public class Test5 {		
		...
		public void removeItem() throws InterruptedException {	
			...
			//arrange
			WebElement removeBtn = driver.findElement(By.xpath("//a[@class='remove-item btn btn-mini btn-danger']"));
			...
			//arrange
			WebElement removePopup = driver.findElement(By.xpath("//div[@class='modal-header']"));
			
			//act
			String removePage = removePopup.getText();
			
			//assert
			Assert.assertEquals(removePage, "Remove Item");
